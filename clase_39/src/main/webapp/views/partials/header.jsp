...
<body class="vh-100">
    <header class="h-15 d-flex flex-row align-items-center bg-success">
        ...
        <div class="w-25 btn-group btn-group-sm px-3">
            <a href="/<%=proyecto%>/views/login.jsp" class="btn btn-secondary me-1 d-<%= !login?"initial":"none" %>">Ingresar</a>
            <a href="#" class="btn btn-secondary me-1 d-<%= !login?"initial":"none" %>">Registrar</a>
            <a href="#" class="btn btn-secondary me-1 d-<%= login?"initial":"none" %>">Mi cuenta</a>
            <a href="/<%=proyecto%>/usuario/logoutUser" class="btn btn-secondary me-1 d-<%= login?"initial":"none" %>"">Salir</a>
        </div>
    </header>
