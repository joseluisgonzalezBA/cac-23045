...
public class Persistencia {
  public static void main(String[] args) {
    ...
    // Necesitamos tener creada una URL compuesta por los siguientes campos:
    //	URL = "jdbc:mysql://<direccion ip>:<puerto>/<bbdd>"
    ...
    try {
      ...
      */
      ...
      System.out.println("Insertados " + regs + " registros.");
      */
      ...
      */
      ...
      int regs = mysqlPrep.executeUpdate();
      System.out.println("Eliminados " + regs + " registros.");
      */
